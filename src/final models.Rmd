...
team 4: "Leon Chen","Baiyan Ren","Qianqian Zhou"
date: "11/12/2022"
...
abline(h=0)
acf(m_arima_ori.res,main= 'ACF of Ori ARIMA Model Residuals')
pacf(m_arima_ori.res,main='PACF of Ori ARIMA Model Residuals')
acf(m_arima_ori.res^2,main= 'ACF of Ori ARIMA Model Residuals Squared')
pacf(m_arima_ori.res^2,main='PACF of Ori ARIMA Model Residuals Squared')
...
acf(m_arima_log.res,main= 'ACF of Log ARIMA Model Residuals')
pacf(m_arima_log.res,main='PACF of Log ARIMA Model Residuals')
acf(m_arima_log.res^2,main= 'ACF of Log ARIMA Model Residuals Sqaured')
pacf(m_arima_log.res^2,main='PACF of Log ARIMA Model Residuals Sqaured')
